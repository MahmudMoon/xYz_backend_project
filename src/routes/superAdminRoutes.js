 ...
 *     description: Retrieve detailed statistics about admins, library tokens, and system usage (super admin only)
 *     tags: [Super Admin]
 *     security:
 *       - SuperAdminAuth: []
 *     responses:
 ...
 *                 message:
 *                   type: string
 *                   example: "Super admin statistics retrieved successfully"
 *                 statistics:
 *                   type: object
 *                   properties:
 *                     admins:
...
router.get(
  "/statistics",
  authenticateSuperAdmin,
  adminController.getSuperAdminStatistics
);
